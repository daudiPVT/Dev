        ...
        <section class="vh-100">
            <div class="container-fluid h-custom">
              <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <form    action="/lab" method="post" class="cmxform" id="signupForm" >
@csrf  
                    <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                      <p class="lead fw-normal mb-0 me-3">Enter Your Username to view Appointments</p>
                    ...
                    <div class="form-outline mb-3">
                      <input type="password" name ="id"  class="form-control form-control-lg"
                        placeholder="Enter ids"  required/>
...
try {
    ...
    echo '<center><img style="height:900px; " src="'.asset('/images/'.$data).'"></center>';
    //echo '<img src="'.asset('/images/'.$data).'" class="rounded float-start" alt="...">';
  } catch (\Exception $e) {
